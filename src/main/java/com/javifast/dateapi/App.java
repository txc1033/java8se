...
public class App {
	...
	public void verificar(int version) {
		if (version == 7) {
			...
			fecha1.set(1994, 9, 11);
			System.out.println(fecha1.after(fecha2));
		} else if (version == 8) {
			LocalDate fecha1 = LocalDate.of(1994, 10, 11);
			...
			LocalDateTime fechaTiempo1 = LocalDateTime.of(1994, 10, 11, 22, 30, 50);
	...
	public void periodoEntreFechas(int version) {
		if (version == 7) {
			...
			nacimiento.set(1994, 9, 11);
			actual.set(2018, 2, 20);
			...
			LocalDate nacimiento = LocalDate.of(1994, 10, 11);
