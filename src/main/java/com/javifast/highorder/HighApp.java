package com.javifast.highorder;
...
public class HighApp {
	...
	public static void main(String[] args) {
		...
		app.imprimir(app.convertirMayusculas, "javifast");
		app.imprimir(app.convertirMinusculas, "JAVIFAST");
		
		String rpta = app.mostrar("Hola ").apply("Javifast");
